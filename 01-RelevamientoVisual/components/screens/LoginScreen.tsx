...
const LoginScreen = () => {
  ...
  return (
    <View style={styles.container}>
      <ImageBackground
        source={require("D:/TecnicaturaEnProgramación/4°Cuatrimestre/PPS/app_pps/01-RelevamientoVisual/assets/background.png")}
        resizeMode="cover"
        style={styles.image}
      >
      <View style={styles.body}>
        <View style={{ flexDirection: "row" , justifyContent: 'center', alignItems: 'center'}}>
          ...
          <Image
              ...
              source={require("D:/TecnicaturaEnProgramación/4°Cuatrimestre/PPS/app_pps/01-RelevamientoVisual/assets/logo.png")}
            />
        </View>
